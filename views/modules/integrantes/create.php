                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-white">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-box"></i> &nbsp; Información Familiar</h3>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input required type="text" class="form-control" id="documentoTalento" name="documentoTalento"
                                                   placeholder="Ingrese el número de documento de identificación de Talento Humano" value="<?= $frmSession['documentoTalento'] ?? '' ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="documentoFamiliar" name="documentoFamiliar"
                                                   placeholder="Ingrese el número de documento del familiar" value="<?= $frmSession['documentoFamiliar'] ?? '' ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="telefono" name="telefono"
                                                   placeholder="Ingrese el teléfono" value="<?= $frmSession['telefono'] ?? '' ?>">
                                        </div>
                                    </div>
