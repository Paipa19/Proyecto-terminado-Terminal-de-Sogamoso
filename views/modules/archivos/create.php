                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-white">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-box"></i> &nbsp; Información del Egreso</h3>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="numeroIdentificacion" name="numeroIdentificacion"
                                                   placeholder="Ingrese el número del identificación" value="<?= $frmSession['numeroIdentificacion'] ?? '' ?>">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="numComprobante" class="col-sm-2 col-form-label">Número Comprobante</label>
                                        <div class="col-sm-8">
