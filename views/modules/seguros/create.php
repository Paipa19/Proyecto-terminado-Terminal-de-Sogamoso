                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-white">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-box"></i> &nbsp; Información de la Afiliación</h3>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input  type="text" class="form-control" id="salud" name="salud"
                                                   placeholder="Ingrese el nombre de la Eps" value="<?= $frmSession['salud'] ?? '' ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="pension" name="pension"
                                                   placeholder="Ingrese el nombre de la Pensión" value="<?= $frmSession['pension'] ?? '' ?>">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="riegosLaborales" class="col-sm-2 col-form-label">Riegos Laborales</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="riegosLaborales" name="riegosLaborales"
                                                   placeholder="Ingrese el nombre de ARL" value="<?= $frmSession['riegosLaborales'] ?? '' ?>">
                                        </div>
                                    </div>
