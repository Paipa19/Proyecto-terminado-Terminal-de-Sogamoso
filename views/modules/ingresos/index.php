                                        ...
                                        <table id="Table" class="records_list table table-striped table-bordered table-hover">
                                            ...
                                            foreach ($arrIngresos as $ingreso) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $ingreso->getId(); ?></td>
                                                    <td><?= $ingreso->getNumeroCaja(); ?></td>
                                                    <td><?= $ingreso->getNumeroBoletin(); ?></td>
                                                    <td><?= $ingreso->getFecha(); ?></td>
                                                    <td><?= $ingreso->getNumeroRecibo(); ?></td>
                                                    <td><?= $ingreso->getNombreBeneficiario(); ?>
                                                    <td><?= $ingreso->getConcepto(); ?></td>
                                                    <td><?= $ingreso->getUsuario()->getNombre(); ?> <?= $ingreso->getUsuario()->getApellido(); ?></td>

                                                    <td>
                                                        <a href="edit.php?id=<?= $ingreso->getId(); ?>"
                                                           type="button" data-toggle="tooltip" title="Actualizar"
                                                           class="btn docs-tooltip bg-navy btn-xs"><i
                                                                    class="fa fa-edit"></i></a>
                                                        <a href="show.php?id=<?= $ingreso->getId(); ?>"
