...
<!-- filtro -->
<link rel="stylesheet" href="<?= $baseURL ?>/views/public/css/estilo_filtro.css">
<!-- Menu_Horizontal -->
<link rel="stylesheet" href="<?= $baseURL ?>/views/public/css/menu_Horizontal.css">
<!-- paginate_button -->
<link rel="stylesheet" href="<?= $baseURL ?>/views/public/css/paginate_button.css">
<!-- search -->
<link rel="stylesheet" href="<?= $baseURL ?>/views/public/css/search.css">
<!-- logo -->
<link rel="icon" type="image/jpg" sizes="32x32" href="<?= $baseURL ?>/views/public/img/user3.png">
